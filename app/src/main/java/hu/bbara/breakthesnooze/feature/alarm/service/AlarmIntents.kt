...
object AlarmIntents {
    ...
    const val ACTION_STOP_ALARM = "hu.bbara.breakthesnooze.alarm.action.STOP_ALARM"
    const val ACTION_PAUSE_ALARM = "hu.bbara.breakthesnooze.alarm.action.PAUSE_ALARM"
