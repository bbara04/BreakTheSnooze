...
class PhoneMessageListenerService : WearableListenerService() {
    ...
    companion object {
        const val MESSAGE_PATH = "/breakthesnooze/alarm-started"
        const val ON_BODY_QUERY_PATH = "/breakthesnooze/onbody-query"
        const val ON_BODY_RESPONSE_PATH = "/breakthesnooze/onbody-response"
